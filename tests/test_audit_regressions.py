...
def _agent_runnable(agent_preconditions):
    """Every test here exercises something other than auth or CLI discovery, so
    run_agent's environment preconditions are stubbed for the whole module. See
    conftest.agent_preconditions."""
