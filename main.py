...
async def api_v1_agent_runs(creds=Depends(verify_auth)):
...
@ui_app.get("/api/v1/schedules")
async def api_v1_schedules_get(creds=Depends(verify_auth)):
...
@ui_app.post("/api/v1/schedules")
async def api_v1_schedules_add(body: ScheduleBody, creds=Depends(verify_auth)):
    try:
...
@ui_app.post("/api/v1/schedules/{sid}")
async def api_v1_schedules_update(sid: str, body: ScheduleBody, creds=Depends(verify_auth)):
    try:
...
@ui_app.delete("/api/v1/schedules/{sid}")
async def api_v1_schedules_delete(sid: str, creds=Depends(verify_auth)):
...
@ui_app.post("/api/v1/schedules/{sid}/run-now")
async def api_v1_schedules_run_now(sid: str, creds=Depends(verify_auth)):
